This is an Arduino sketch to drive a Sonos Zone Player via an InfraRed receiver. There are [more gory details](http://jpmens.net/2010/04/24/the-sonos-pause-switch-reloaded-and-remote-controlled/).
